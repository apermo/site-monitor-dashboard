...
- Stale bot no longer auto-closes inactive issues and pull requests; they are
  still labeled stale (`days-before-close: -1`)

### Fixed

- Plugin header version was stuck at `0.1.1` while releases had already moved
  on to `0.1.3`
...
[0.1.4]: https://github.com/apermo/site-bookkeeper-dashboard/compare/v0.1.3...v0.1.4
